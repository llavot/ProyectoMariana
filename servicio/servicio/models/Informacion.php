...
class Informacion {
  ...
  static public function mdlRegistro($table, $data) {
    ...
    $stmt = Conexion::conectar()->prepare("INSERT INTO $table( titulo, img, descripcion ) VALUES ( :titulo, :img, :descripcion )");
...
static public function mdlEditarRegistro($table, $data){
  ...
  $stmt = Conexion::conectar()->prepare("UPDATE $table SET titulo  = :titulo, img = :img, descripcion = :descripcion WHERE id = :id");
